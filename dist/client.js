...
var WeComSettingsController = class {
  ...
  scheduleStatusPoll() {
    ...
    for (const delay of [1e3, 3e3, 6e3, 1e4]) {
      this.statusTimers.push(setTimeout(() => {
  ...
  async refreshStatus() {
    if (this.state.status !== "ready" || this.state.action !== void 0) return;
...
function LoadedSettings({ controller }) {
  ...
  const [wsDraft, setWsDraft] = (0, import_react.useState)("");
  const [wsError, setWsError] = (0, import_react.useState)(void 0);
  (0, import_react.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "wc-settings", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "wc-panel", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "wc-panel-note", children: "\u5019\u9009\u5DE5\u4F5C\u533A\u5217\u8868\uFF1A\u5728\u4F01\u5FAE\u91CC\u53D1\u9001 /ws \u53EF\u67E5\u770B\u5E76\u7528\u7F16\u53F7\u5207\u6362\uFF08\u5207\u6362\u4F1A\u5F00\u542F\u65B0\u5BF9\u8BDD\uFF09\uFF0C\u53D1\u9001 /ws add \u8DEF\u5F84 \u4E5F\u53EF\u65B0\u589E\u3002 \u5E26\u300C\u9ED8\u8BA4\u300D\u6807\u8BB0\u7684\u662F /ws \u5217\u8868\u7684\u7B2C\u4E00\u9879\uFF1B\u70B9\u300C\u8BBE\u4E3A\u9ED8\u8BA4\u300D\u53EF\u5207\u6362\u9ED8\u8BA4\uFF0C\u4FDD\u5B58\u540E\u4F1A\u628A\u73B0\u6709\u4F01\u5FAE\u5BF9\u8BDD\u4E5F\u5207\u5230\u65B0\u9ED8\u8BA4\uFF08\u5404\u81EA\u5F00\u65B0\u5BF9\u8BDD\uFF09\u3002" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "wc-save-row", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "wc-button primary", disabled: busy || wsDraft.trim().length === 0, onClick: addWorkspace, children: "\u65B0\u589E" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "wc-details", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { className: "wc-checklist", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "/ws" }),
          " \u2014 \u67E5\u770B/\u5207\u6362/\u65B0\u589E\u5DE5\u4F5C\u533A"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
